...
var loadFont = loading.loadFont = function(fontBuffer, callback) {
  ...
  f.characterMap = new Array(maxCharacter + 1);
  var glyphs = 0;
...
// Read a font file produced by font2openvg.js
var loadJSONFont = loading.loadJSONFont = function(name) {
  ...
  for (var i = 0; i < jsonf.glyphCount; i++) {
    ...
    var path = vg.createPath(vg.VG_PATH_FORMAT_STANDARD, vg.VGPathDatatype.VG_PATH_DATATYPE_S_32,
                                 1.0 / 65536.0, 0.0, 0, 0,
                                 vg.VGPathCapabilities.VG_PATH_CAPABILITY_ALL);
